...
type
  ...
  public
    ...
    function DSET(pSQL : string; pParams : array of variant; pReadonly : boolean): TDSetNode;overload;
    function DSET(pSQL : string; pParams : array of variant; pSource : tdatasource; pKeyFields : string; pReadonly : boolean): TDSetNode;overload;override;
...
procedure TDMDATA.ChangeParam(sender: TObject; pParamName, value: string);
begin
  inherited;
...
begin
  ...
  DSList[High(DSList)].ds := d;
  DSList[High(DSList)].src := s;

  result := DSList[High(DSList)];
end;

function TDMDATA.DSET(pSQL : string; pParams : array of variant; pReadonly : boolean): TDSetNode;
var
  d : TpFIBDataSet;
  s : TDataSource;
  t, tu : TpFIBTransaction;
...
function TDMDATA.GetParam(sender: TObject; pParName: string): string;
var
  nm, par, val : string;
begin
